...
class UPFTest():
    ...
    def manage_script_services(self):
        ...
        self._log.info("Waiting {} seconds for PFCP association request and response between UPF amd SMF nodes.".format(TestCaseConstants.SLEEP_TIME))
    ...
    def validate_pcap(self):
        ...
        self.smf_helper_obj.validate_real_node_pcap(UPFConstants.ASSOCIATION_SETUP, 2)
