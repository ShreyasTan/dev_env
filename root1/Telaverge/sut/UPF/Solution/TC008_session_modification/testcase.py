...
Steps:
    ...
    6. AMF Simulator will start sending post request to SMF, SMF will send request to UPF for Session creation and Modification
...
class UPFTest():
    ...
    def setup_scripts(self):
        ...
        self.unicorn_helper_obj.setup_real_node_script(UPFConstants.SESSION_MODIFICATION)
    ...
    def manage_script_services(self):
        ...
        time.sleep(3)
        self._log.info("AMF simulator executing Session Modification testcase.")
        self.unicorn_helper_obj.start_tc_execution()
        self._log.info("AMF simulator executed Session Modification testcase.")
    ...
    def validate_pcap(self):
        ...
        self.smf_helper_obj.validate_real_node_pcap(UPFConstants.SESSION_MODIFICATION, 6)
