...
Steps:
    ...
    4. SMF simulator will send 1 packet towards UPF and UPF inturn will process and create some entries.
    5. UPF responds back towards SMF with the successful cause.
    6. AMF Simulator will start sending post request to SMF, SMF will send request to UPF for Session creation 
        and UPF inturn will process and create some entries.
...
class UPFTest():
    ...
    def setup_scripts(self):
        ...
        self.unicorn_helper_obj.setup_real_node_script(UPFConstants.SESSION_CREATION)
    ...
    def manage_script_services(self):
        ...
        time.sleep(3)
        self._log.info("AMF simulator executing Session Creation testcase.")
        self.unicorn_helper_obj.start_tc_execution()
        self._log.info("AMF simulator executed Session Creation testcase.")
    ...
    def validate_pcap(self):
        ...
        self.smf_helper_obj.validate_real_node_pcap(UPFConstants.SESSION_CREATION, 4)
